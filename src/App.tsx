...
import ConceptDetailPage from "./pages/ConceptDetailPage"; // ✅ Add this line
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/study/:subjectId/:conceptId" element={<ConceptDetailPage />} /> {/* ✅ Add route for concept details */}
      </Routes>
    </BrowserRouter>
  );
}
